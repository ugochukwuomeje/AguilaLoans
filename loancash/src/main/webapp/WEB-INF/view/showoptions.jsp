              ...
              <div class="welcome-form col-lg-6 mb-5">
                <div class="card">
                  <div class="card-header">
                    <h3 class="h6 text-uppercase mb-0">MAIN MENU</h3>
                  </div>
                  <div class="card-body">
                    <p>
                    	Welcome <span style="color:red">${phonenumbers.phonenumber}</span>. Not Your Number ?<br>Please select an option below to continue
                   </p>
                    <sf:form class="form" method="POST" action="/gettransactionoption" modelAttribute="myoption" >
                      <div class="form-group">
                      <label>Options</label>
                                              
							<c:forEach items="${alloptions}" var="option">
								<div class="form-group">
									<sf:radiobutton path="id" value="${option.id}" name="selectedoption"/> ${option.singleoption}
								</div>	
							</c:forEach>
