              ...
              <div class="welcome-form col-lg-6 mb-5">
                <div class="card">
                  <div class="card-header">
                    <h3 class="h6 text-uppercase mb-0">REQUEST LOAN</h3>
                  </div>
                  <div class="card-body">
                    <p class="alert_message">
				     	...
				     	<c:if test="${first.firttimer == false}">
					     		...
					     		Please select a term for your <fmt:formatNumber  value="${amount}" type="number" /> loan.
					     			
				     	</c:if>
                    	
                   </p>
                    <sf:form class="form" method="POST" action="/selectacc" modelAttribute="paymentterm" >
