              ...
              <div class="welcome-form col-lg-6 mb-5">
                <div class="card">
                  <div class="card-header">
                    <h3 class="h6 text-uppercase mb-0">CONFIRM LOAN</h3>
                  </div>
                  <div class="card-body">
                    <p class="alert_message">
                    Please verify the following information                    	                    	
                   </p>
                    <sf:form class="form" method="POST" action="/transfer" modelAttribute="paymentterm" >
                    	<div class="row">
                    		...
                    		<div class="col-sm-6">
                    			${selectedloanamount.selectedamount}
                    		</div>
                    	...
                    	<div class="row">
                    		You will owe ${amounttopay} amount + interest due on Wednesday , October 30,2019 
                    	</div>
                    	
                    	<div class="row">
                    		Confirm and agree to our <span style="color: #4680ff">terms and condition</span>. 
                    	</div>
                      ...
                      <label style="font-size:1em;"><strong></strong></label><br>
                           ...
                           <c:if test="${first.firttimer == true }">
								<div class="form-group">
									<sf:radiobutton path="paymentterm" value="1" name="selectedoption"/>&nbsp;&nbsp;Due in ${firstduedate}  days at ${firstinterest}% interest
								</div>	
							</c:if>
							...
							<c:if test="${first.firttimer == false}">
								...
								<div class="form-group">
									<sf:radiobutton path="paymentterm" value="2" name="selectedoption"/>&nbsp;&nbsp;Due in ${secondduedate}  days at ${secondinterest}% interest
								</div>		
							</c:if>
                      </div>
