            ...
            <div class="row">
              ...
              <div class="welcome-form col-lg-6 mb-5">
                <div class="card">
                  ...
                  <div class="card-body">
                    <p class=""></p>
                    <sf:form class="checknumber_form" action="/sendcode" modelAttribute="phonenumbers" method="POST">
                    
                    	
				     		<c:if test="${captcherstatus == 'failed'}">
				     		...
				     		<c:if test="${messagestatus == 'failed'}">
                      ...
                      <div class="form-group">
                        <label class="form-control-label text-uppercase">Confirm Phone Number</label>
                        <sf:input type="text" value="${phonenumbers.phonenumber}" class="form-control" path="phonenumber"/>
                      </div>
                     
                      <div class="form-group">  
                      	 <div class="g-recaptcha" data-sitekey="6LcdgbwUAAAAACMC7VeiJSMa40PDwF-ZnlBh2Mqw"></div><br>     
